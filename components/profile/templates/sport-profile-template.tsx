  ...
  return (
    <main
      ...
      style={{
        ...
        backgroundImage: `linear-gradient(135deg, color-mix(in srgb, ${theme.coverColor} 72%, ${visual.canvas}), color-mix(in srgb, ${visual.accent} 28%, ${visual.canvas}))`,
        color: visual.text,
          ...
          >
            {contentBlocks.map((block, index) => (
              <SportContentBlock
                ...
                block={block}
                blockKey={
                  block.id ?? `${block.type}-${block.sortOrder}-${index}`
                }
