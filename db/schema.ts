...
export const profile_achievements = pgTable(
  'profile_achievements',
  {
    ...
    achievement_type: varchar('achievement_type', { length: 40 }),
    achievement_type_label: varchar('achievement_type_label', { length: 80 }),
    event_name: varchar('event_name', { length: 160 }),
    description: text('description'),
    image_url: text('image_url'),
    result_url: text('result_url'),
    result_link_label: varchar('result_link_label', { length: 80 }),
